...
近期已把单音短句、常用和弦、和弦库分类/收藏、练习模板、首页快捷入口、首页热门推荐、学习页专题入口、曲谱展示字段、扩展曲目、课程展示字段、推荐路径、练习模拟 fixture、节拍器速度预设、调音器展示配置、歌曲详情展示配置、练习入口展示配置、课程详情展示配置和我的/记录页展示配置沉到 `packages/shared`。
